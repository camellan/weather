        ...
        public OWM_Today (string idplace) {
            ...
            try {
                ...
                if (save) {
                    ...
                    dos.put_string (_("Location: ") + setting.get_string ("location") + "\n");
                    dos.put_string (_("State: ") + setting.get_string ("state") + "\n");
                    dos.put_string (_("Country: ") + setting.get_string ("country") + "\n");
